...
### Last Full Verification: Feb 28, 2026 (Iteration 2400 — Re-confirmation)
...
- Prove times: fibonacci 5.7s, collatz 23.0s, factorial 5.5s, sum 5.4s, signed 5.5s, primes 27.2s, gcd 10.4s, bitwise 10.9s
