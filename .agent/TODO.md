...
### Last Full Verification: Feb 28, 2026 (Iteration 2384 — Re-confirmation)
...
- Prove times: fibonacci 5.6s, collatz 23.0s, factorial 5.6s, sum 5.4s, signed 5.5s, primes 27.1s, gcd 10.2s, bitwise 10.8s
