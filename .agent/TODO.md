...
### Last Full Verification: Feb 28, 2026 (Iteration 2412 — Re-confirmation)
...
- Prove times: fibonacci 5.7s, collatz 23.0s, factorial 5.7s, sum 5.5s, signed 5.5s, primes 27.3s, gcd 10.3s, bitwise 10.9s
