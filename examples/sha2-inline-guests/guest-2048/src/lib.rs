...
/// SHA-256 of a fixed 2048-byte input using the Jolt inline implementation.
///
...
#[jolt::provable(heap_size = 65536, max_trace_length = 262144)]
fn sha256_inline_2048() -> [u8; 32] {
    let buf = [0u8; 2048];
