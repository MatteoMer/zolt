 ...
 */
async function generateSmithersScript(task, options) {
 ...
 */
async function writeScriptFile(script, scriptPath) {
    const filePath = scriptPath || path.join(os.tmpdir(), `smithers-subagent-${Date.now()}.tsx`);
 ...
 */
export async function executeSmithers(options) {
    const startTime = Date.now();
    try {
...
//# sourceMappingURL=SmithersCLI.js.map