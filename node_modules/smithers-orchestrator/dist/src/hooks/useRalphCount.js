 ...
 */
export function useRalphCount() {
    const { db } = useSmithers();
    const { data } = useQueryValue(db.db, "SELECT CAST(value AS INTEGER) as count FROM state WHERE key = 'ralphCount'");
    return data ?? 0;
}
//# sourceMappingURL=useRalphCount.js.map