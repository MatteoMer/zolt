 ...
 * ```
 */
export declare function useQueryOne<T = Record<string, unknown>>(sqlOrDb: ReactiveDatabase | string, sqlOrParams?: string | any[], paramsOrOptions?: any[] | UseQueryOptions, optionsOrDb?: UseQueryOptions | ReactiveDatabase): Omit<UseQueryResult<T>, 'data'> & {
    data: T | null;
};
//# sourceMappingURL=useQueryOne.d.ts.map