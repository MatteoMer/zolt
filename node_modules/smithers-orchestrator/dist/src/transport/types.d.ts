...
export type SmithersTable = 'executions' | 'phases' | 'agents' | 'tool_calls' | 'state' | 'transitions' | 'artifacts' | 'reports' | 'commits' | 'snapshots' | 'reviews' | 'tasks' | 'steps' | 'human_interactions' | 'render_frames';
