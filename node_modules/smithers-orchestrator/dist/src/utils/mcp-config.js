 ...
 */
export function extractMCPConfigs(childrenString) {
    const configs = [];
    ...
    while ((match = mcpToolRegex.exec(childrenString)) !== null) {
        ...
        try {
            if (!type || !configJson)
                throw new Error('Missing type or config');
 ...
 */
export function generateMCPServerConfig(configs) {
    const mcpConfig = {
        mcpServers: {},
    };
 ...
 */
export async function writeMCPConfigFile(config) {
