...
export async function git(...args) {
    try {
        ...
        const stderr = error instanceof Object && 'stderr' in error ? String(error.stderr) : '';
 ...
 */
export async function getCommitHash(ref = 'HEAD') {
    try {
 ...
 */
export async function getCommitInfo(ref = 'HEAD') {
    try {
 ...
 * Get diff statistics
 */
export async function getDiffStats(ref) {
 ...
 */
export async function addGitNotes(content, ref = 'HEAD', append = false) {
 ...
 */
export async function getGitNotes(ref = 'HEAD') {
    try {
 ...
 */
export async function hasGitNotes(ref = 'HEAD') {
 ...
 * Add a new worktree
 */
export async function addWorktree(worktreePath, branch, options) {
 ...
 */
export async function worktreeExists(worktreePath, cwd) {
