 ...
 */
export async function getJJChangeId(ref = '@') {
    try {
 ...
 */
export async function jjSnapshot(message) {
 ...
 * Create a JJ commit
 */
export async function jjCommit(message) {
 ...
 */
export async function getJJDiffStats() {
 ...
 */
export async function isJJRepo() {
    try {
