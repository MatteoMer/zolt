...
pub fn Preprocessing(comptime F: type) type {
    return struct {
        ...
        pub fn preprocess(
            ...
            // Generate SRS
            dbg("    [preprocess] Generating SRS (size={})...\n", .{srs_size});
            const srs = try HyperKZG.setup(self.allocator, srs_size);
            dbg("    [preprocess] SRS generated!\n", .{});
